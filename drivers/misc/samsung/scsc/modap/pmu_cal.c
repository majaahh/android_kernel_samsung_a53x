...
static char *pmu_cal_getsfr(int sfr)
{
	...
	case WLBT_OPTION:
		return "WLBT_OPTION";
#if defined(CONFIG_SOC_S5E5535) || defined(CONFIG_SOC_S5E8535) || defined(CONFIG_SOC_S5E8835) || defined(CONFIG_SOC_S5E8845)
...
#if defined(CONFIG_SOC_S5E5535) || defined(CONFIG_SOC_S5E8835) || defined(CONFIG_SOC_S5E8845)
	(void)i3c_regmap;
	return pmu_regmap;
#else
	if (pmureg)
